...
const translations = {
  en: {
    ...
    "news.title": "The latest<br /><em>updates.</em>", "news.copy": "The project is moving forward. Here is what changed in the Xiee OS repository on September 26, 2026.", "news.iso.label": "ISO / INSTALLATION", "news.iso.title": "The first bootable<br />Xiee OS image", "news.iso.copy": "The repository now includes rootfs and ISO build scripts, plus a binary installer. The latest commit reports a generated Xiee OS 0.1.0 image at 106 MB.", "news.iso.link": "Build scripts ↗", "news.desktop.label": "DESKTOP", "news.desktop.title": "The desktop<br />does more.", "news.desktop.copy": "Desktop shortcuts refresh automatically. Windows can be minimized without pausing apps, and XIARR can add desktop shortcuts.", "news.tools.label": "EVERYDAY TOOLS", "news.tools.title": "Discord and new<br />tools.", "news.tools.copy": "Discord is now in the launcher. Xiee-shell keeps command history, and coreutils gained tools including xmkdir and xrm.", "news.note": "The project reports a successful CI build on September 26, 2026. The generated ISO is described in the repository; no downloadable release asset was found.", "news.repo": "Xiee repository <span>↗</span>",
...
const languageElements = {
  ...
  "arch.title": "#architektura .centered h2", "arch.copy": "#architektura .centered p", "layers": ".stack-label", "components.title": "#komponenty .section-intro h2", "components.copy": "#komponenty .section-intro p", "news.title": "#nowosci .section-intro h2", "news.copy": "#nowosci .section-intro p", "news.iso.label": ".news-feature .news-meta span:nth-child(2)", "news.iso.title": ".news-feature h3", "news.iso.copy": ".news-feature p", "news.iso.link": ".news-feature .news-foot a", "news.desktop.label": ".news-card:nth-child(2) .news-meta span:nth-child(2)", "news.desktop.title": ".news-card:nth-child(2) h3", "news.desktop.copy": ".news-card:nth-child(2) p", "news.tools.label": ".news-card:nth-child(3) .news-meta span:nth-child(2)", "news.tools.title": ".news-card:nth-child(3) h3", "news.tools.copy": ".news-card:nth-child(3) p", "news.note": ".news-note p", "news.repo": ".news-note a", "tab.desktop": "[data-component=desktop] span:nth-child(2)", "tab.xiac": "[data-component=xiac] span:nth-child(2)", "tab.xiarr": "[data-component=xiarr] span:nth-child(2)", "tab.xihh": "[data-component=xihh] span:nth-child(2)", "tab.xfm": "[data-component=xfm] span:nth-child(2)",
...
const setLanguage = (language) => {
  ...
  document.querySelector(".timeline-item:nth-child(4) small").textContent = language === "en" ? "STAGE 03 / COMPLETE" : "ETAP 03 / GOTOWE";
  document.querySelector(".timeline-item:nth-child(5) small").textContent = language === "en" ? "STAGE 04 / NEXT" : "ETAP 04 / NASTĘPNIE";
  document.querySelector(".faq-list details:nth-child(3) p").textContent = language === "en"
    ? "The repository includes scripts to build a rootfs and bootable ISO, and the project reports generating image 0.1.0. Check the repository for the latest instructions and available files."
    : "Repozytorium zawiera skrypty budowania rootfs i bootowalnego ISO; projekt zgłasza wygenerowanie obrazu 0.1.0. Sprawdź repozytorium, aby zobaczyć aktualne instrukcje i dostępne pliki.";
  document.querySelector(".site-footer>span").textContent = "© 2026 Xiee OS · MIT License";
